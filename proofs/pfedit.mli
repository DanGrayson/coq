...
val cook_this_proof : (Proof.proof -> unit) ->
  ...
  Id.t *
    (Entries.definition_entry * Univ.constraints * lemma_possible_guards
     * goal_kind * unit declaration_hook Ephemeron.key)
...
val current_proof_statement :
  unit -> Id.t * goal_kind * types * Proof_global.proof_decl_hook Ephemeron.key
