...
val get_instantiated_arity :            'a * Univ.Instance.t ->
           Declarations.mutual_inductive_body *
           Declarations.one_inductive_body ->
           Term.constr list -> Context.rel_context * Term.sorts_family

val is_correct_arity : 
           Environ.env ->
           Term.constr ->
           Environ.unsafe_judgment ->
           Names.inductive Term.puniverses ->
           Declarations.mutual_inductive_body *
           Declarations.one_inductive_body -> Term.constr list -> unit
