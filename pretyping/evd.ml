...
let merge_metas metas1 metas2 =
  Metamap.fold Metamap.add metas1 metas2
...
let set_metas evd ?(universes=evd.universes) metas = {
...
let meta_merge evd1 evd2 =
  ...
  let metas = merge_metas evd1.metas evd2.metas in
  set_metas evd2 ~universes metas
